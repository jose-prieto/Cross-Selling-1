...
class pet_load:
    ...
    def __init__(self, ruta, cartera, fecha):
        ...
        self.df = pd.read_excel(ruta + '\cash_llena.xlsx', usecols = 'A,B', sheet_name = 'PET', dtype=str, header=0, index_col=False, keep_default_na=True)
        ...
        print("PET total: ", self.df['monto'].sum())
