    ...
    def insertDf(self):
        ...
        try:
            for indice_fila, fila in self.dfBs.iterrows():
                try:
                    cursor.execute("INSERT INTO AHORRO_CORRIENTE ([mis], [monto], [fecha]) VALUES(?,?,?)", 
                                   fila["mis"], 
                                   fila["monto"], 
                                   fila["fecha"])
            ...
            for indice_fila, fila in self.dfDolar.iterrows():
                try:
                    cursor.execute("INSERT INTO CONVENIO ([mis], [monto], [fecha]) VALUES(?,?,?)", 
                                   fila["mis"], 
                                   fila["monto"], 
                                   fila["fecha"])
                except KeyError as llave:
            ...
            for indice_fila, fila in self.dfEuro.iterrows():
                try:
                    cursor.execute("INSERT INTO CTA_EUROS ([mis], [monto], [fecha]) VALUES(?,?,?)", 
                                   fila["mis"], 
                                   fila["monto"], 
                                   fila["fecha"])
                except KeyError as llave:
